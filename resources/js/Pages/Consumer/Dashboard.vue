...
export default {
    ...
    props: ['meter', 'tokens', 'total_units', 'used_units', 'appliances'],
    components: {
        AppLayout
    },
    data() {
                ...
                <div class="grid row-3 grid-cols-1 lg:col-span-4">
                    ...
                    <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 mb-8 items-center">
                        <div class="bg-white shadow rounded dark:bg-dark-card p-6 text-center dark:text-white">
                            <h2 class="dark:text-white mb-4">{{ appliances }}</h2>
                            <h5 class="dark:text-white mb-0">Appliances</h5>
                        </div>
                        <div class="bg-white shadow rounded dark:bg-dark-card p-6 text-center">
                            <h2 class=" dark:text-white mb-4">{{ meter.current_units }}watts</h2>
                            <h5 class="dark:text-white mb-0">Current Meter Units</h5>
                        </div>
                        <div class="bg-white shadow rounded dark:bg-dark-card p-6 text-center">
                            <h2 class="dark:text-white mb-4">{{ total_units }}watts</h2>
                            <h5 class=" dark:text-white mb-0">Total Units</h5>
                        </div>
                        <div class="bg-white shadow rounded dark:bg-dark-card p-6 text-center">
                            <h2 class="dark:text-white mb-4">{{ used_units }}watts</h2>

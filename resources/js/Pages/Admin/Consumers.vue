    ...
    methods: {
        deleteUser(id) {
            if (confirm('Are you sure you want to delete this user?')) {
                this.$inertia.delete(route('delete.users', id))
                ...
                <div class="flex-auto w-full">
                    <div class="relative flex flex-col mb-8  bg-white dark:bg-dark-card shadow rounded">
                        <div class="flex justify-between flex-auto p-5 border-b dark:border-secondary-800 rounded">
                            <h4 class="mb-0 dark:text-secondary-200">Consumers</h4>
                        </div>
                                ...
                                <div class=" overflow-x-auto p-5">
                                    <div class="flex flex-wrap justify-between my-6 mx-5">
                                        <div class="flex justify-center items-center mb-1">
                                            ...
                                            <div class="flex justify-center items-center mb-1">
                                                <Link :href="'/admin/consumer/create'" class="btn btn-primary mb-2">Create
                                                New
                                                Consumer</Link>
                                            </div>
                                        </div>
                                                ...
                                                <tr v-for="consumer in consumers">
                                                    ...
                                                    <td class="px-6 py-4"><span
                                                            class="inline-block whitespace-nowrap px-2 py-1 text-xs text-center font-bold leading-none text-white bg-primary-500 rounded">{{
                                                                consumer.user_type }}</span>
                                                    </td>

                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-secondary-600 dark:text-secondary-500">
                                                        {{ consumer.created_at }}</td>
                                                    <td class="px-6 py-4">
                                                        <div class="flex items-center list-user-action">

                                                            <a class="btn btn-warning btn-icon btn-sm mr-1" href="#"
                                                                type="button" data-tp-toggle="tooltip"
                                                                data-tp-placement="top" data-tp-title="Edit">
                                                            ...
                                                            <a class="btn btn-danger btn-icon btn-sm mr-1" href="#"
                                                                @click.prevent="deleteUser(consumer.id)" type="button"
                                                                data-tp-toggle="tooltip" data-tp-placement="top"

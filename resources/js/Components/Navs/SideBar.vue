...
<template>
    <aside x-data="sidebar"
        ...
        class="z-50 sidebar shadow-lg sidebar-base sidebar-default " data-toggle="main-sidebar" id="first-tour">
        <div class="sidebar-header relative flex items-center justify-start mb-3 border-b dark:border-gray-700 z-0">
            <a :href="user.user_type == 'consumer' ? '/consumer/dashboard' : '/admin/dashboard'"
                ...
                <!--logo End-->
                <h4 class="sidebar-logo" data-setting="app_name" x-text="setting.app_name">Electricity Consumption</h4>
            </a>
            ...
            <ul class="sidebar-main-menu">
                ...
                <li class="nav-item active">
                    <Link class="nav-link active" aria-current="page"
                        :href="user.user_type == 'consumer' ? '/consumer/dashboard' : '/admin/dashboard'">
                ...
                <li class="nav-item" v-if="user.user_type =='admin'">
                    <Link class="nav-link  " aria-current="page"
                        :href="user.user_type == 'consumer' ? '/consumer/consumptions' : '/admin/consumptions'">
                    ...
                    <span class="item-name">Consumption</span>
                    </Link>
                </li>
                <li class="nav-item " v-if="user.user_type == 'admin'">
                    <Link class="nav-link " aria-current="page" :href="'/admin/meters'">
                    ...
                    <span class="item-name">Meters</span>
                    </Link>
                </li>
                <li class="nav-item " v-else>
                    <Link class="nav-link " aria-current="page" :href="'/consumer/meter'">
                    <i class="icon" data-tp-toggle="tooltip" data-tp-placement="left" data-tp-title="Crypto">
                        <svg class="icon-20" width="20" height="20" viewBox="0 0 14 14" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4"
                    ...
                    <span class="item-name">Meter</span>
                    </Link>
                </li>
                ...
                <li class="nav-item" v-if="user.user_type == 'admin'">
                    <Link class="nav-link" :href="'/admin/consumers'">
                    ...
                    <span class="item-name ">Consumers</span>

                    </Link>
                </li>

                <li class="nav-item">
                    <Link class="nav-link" :href="user.user_type == 'consumer' ? '/consumer/tokens' : '/admin/tokens'">
                    <i class="icon" data-tp-toggle="tooltip" data-tp-title="Utilites" data-tp-placement="left">
                        <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4"
                ...
                <li class="nav-item">
                    <Link class="nav-link "
                        :href="user.user_type == 'consumer' ? '/consumer/appliances' : '/admin/appliances'">
                    <i class="icon" data-tp-toggle="tooltip" data-tp-title="Blank Page" data-tp-placement="left">
                    ...
                    <span class="item-name ">Appliances</span>
                    </Link>
                </li>
                <li class="nav-item">
